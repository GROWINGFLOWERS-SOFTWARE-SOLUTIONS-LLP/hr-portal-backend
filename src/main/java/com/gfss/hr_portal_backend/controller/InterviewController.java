...
public class InterviewController {
	...
	@GetMapping
	public ResponseEntity<Page<InterviewEntity>> getAllInterviews(
	        @RequestParam(defaultValue = "0") int page,
	        @RequestParam(defaultValue = "10") int size) {
	    Pageable pageable = PageRequest.of(page, size);
	    Page<InterviewEntity> interviews = interviewService.getAllInterviews(pageable);
	...
	public ResponseEntity<InterviewEntity> getInterview(@PathVariable String interviewId) {
		return interviewService.getInterviewById(interviewId).map(ResponseEntity::ok)
	...
	public ResponseEntity<Page<InterviewEntity>> searchByCandidateName(@RequestParam String candidateName,
			Pageable pageable) {
	...
	public ResponseEntity<Page<InterviewEntity>> searchByCandidateEmail(@RequestParam String candidateEmail,
			Pageable pageable) {
